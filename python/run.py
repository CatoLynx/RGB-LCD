                    ...
                    if not hackertours_boarding:
                        ...
                        if tours:
                            ...
                            for i, tour in enumerate(items):
                                ...
                                dep_image = renderer.render_text(width=72, height=16, pad_left=0, pad_top=0, font="12_DBLCD", size=0, halign='right', valign='middle', inverted=True, spacing=1, char_width=None, text=dep_str)
